 ...
 //isEditable = false;
  ...
  buildForm():void{
    this.FrmInfGeneral = this.fb.group({
      ...
      legalrepresentativealt1: new FormControl('', Validators.required),
      emaillegalrepresentativealt1: new FormControl('', Validators.pattern(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)),
      typedocrepresentativealt1: new FormControl('', Validators.required),
      documentrepresentativealt1: new FormControl('', Validators.required),
      chargerepresentativealt1: new FormControl('', Validators.required),
      legalrepresentativealt2: new FormControl(''),
      emaillegalrepresentativealt2: new FormControl(''),
